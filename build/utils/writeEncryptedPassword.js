...
var writeEncryptedPasswords = function (key, data, passHeroPasswordListPath) {
    ...
    try {
        ...
        (0, fs_1.writeFileSync)(passHeroPasswordListPath, JSON.stringify(encryptedDataToSave), { encoding: "utf-8" });
        return true;
    }
    catch (err) {
